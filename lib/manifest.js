(function () {
  ...
  window.__BRAND__ = {
    ...
    stats: [
      { value: 3000, prefix: "+", suffix: "", label: "Negocios atendidos" },
      { value: 2, prefix: "+", suffix: "M", label: "Conversaciones gestionadas" },
      { value: 35, prefix: "+", suffix: "%", label: "Aumento promedio en ventas" },
      { value: 24, prefix: "", suffix: "/7", label: "Atención sin interrupciones" }
    ],
